	...
	public void desconectar(String nome) {
		try {
			...
			if (registry.list().length > 0) {
				...
				System.out.println("Nenhum servidor ativo encontrado no registro.");
			}
		} catch (Exception e) {
			System.err.println("Erro ao obter o registro: " + e.getMessage());
		}
	}

	@Override
	public void desconectar_peer(String nome) throws RemoteException {
		desconectar(nome);
	}
