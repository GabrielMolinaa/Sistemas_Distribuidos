	...
	public void iniciarCliente(){
        ...
        try {
            ...
            do {
            	...
            	switch(opcao){
            	case "1":
					mensagem = new Mensagem("", opcao);
            		resposta = stub.enviar(mensagem); //dentro da mensagem tem o campo 'read'
            	...
            	case "2":
					...
					mensagem = new Mensagem(fortune, opcao);
					resposta = stub.enviar(mensagem); //dentro da mensagem tem o campo 'write'
            		System.out.println(resposta.getMensagem());
            		break;
				case "x":
					...
					try {
						stub.desconectar_peer(peer.getNome());
